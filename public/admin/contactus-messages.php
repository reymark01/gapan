...
if (Input::exist()) {
  if (!empty(Input::get('done'))) {
    $sql = "UPDATE contact_us SET contactus_status = 1 WHERE id = :id";
  ...
  <body>
    ...
    <div class="page">
      ...
      <div class="container-fluid">
          <div class="row">
<?php
$sql2 = "SELECT * FROM contact_us WHERE contactus_status = 0";
            ...
            <div class="card" style="margin: 15px; ">
              <div class="card-body">
                <form action="" method="post">
                  '.$row['contactus_email'].'<br><br>
                  '.$row['contactus_message'].'<br>
                  <input type="hidden" name="id" value="'.$row['id'].'">
                  <div class="card-footer d-flex justify-content-center">
                    <button type="submit" class="btn btn-danger" name="done" value="done">Done</button>
                  </div>
                </form>
                </div>
              </div>
