    ...
    <div class="row flex-sm-row-reverse">
      <div class="col-sm-8">
        <div class="card" style="margin-top: 20px;">
          <div class="card-header bg-primary text-white text-center">Gapan City Gymnasium</div>
            <div class="card-body">
              <div class="img"><img src="/tourism/image2/17.jpg" class="img-fluid" style="height: 400px;"></div>
            </div>
        </div>
        <div class="card" style="margin-top: 20px;">
          <div class="card-header bg-primary text-white text-center">Gapan City Gymnasium</div>
            <div class="card-body">
               <iframe class="col-sm-12" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3537.575997407585!2d120.94739461525025!3d15.309047989354418!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x339721b1baa351c7%3A0xc0e6e10f36b36c2d!2sGapan+City+Gym%2C+Don+Manuel+St%2C+Gapan+City%2C+Nueva+Ecija!5e1!3m2!1sen!2sph!4v1551450546603" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
            </div>
        </div>
    </div>
