    ...
    <div class="row flex-sm-row-reverse">
      <div class="col-sm-8">
        <div class="card" style="margin-top: 20px;">
          <div class="card-header bg-primary text-white text-center">Sizzlers</div>
            <div class="card-body">
              <div class="img"><img src="/tourism/image2/11.jpg" class="img-fluid" style="height: 400px;"></div>
            </div>
        </div>
        <div class="card" style="margin-top: 20px;">
          <div class="card-header bg-primary text-white text-center">Sizzlers</div>
            <div class="card-body">
              <iframe class="col-sm-12" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3777.9908705628523!2d120.95287441479793!3d15.314660089350895!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x339721a5db4ce69b%3A0xc0f7f1a48b2ed99a!2sSizzlers!5e1!3m2!1sen!2sus!4v1551443092773" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
            </div>
        </div>
    </div>
