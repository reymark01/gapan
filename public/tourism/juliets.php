    ...
    <div class="row flex-sm-row-reverse">
      <div class="col-sm-8">
        <div class="card" style="margin-top: 20px;">
          <div class="card-header bg-primary text-white text-center">Juliet's Restaurant + Events</div>
            <div class="card-body">
              <div class="img"><img src="/tourism/image2/12.jpg" class="img-fluid" style="height: 400px;"></div>
            </div>
        </div>
        <div class="card" style="margin-top: 20px;">
          <div class="card-header bg-primary text-white text-center">Juliet's Restaurant + Events</div>
            <div class="card-body">
              <iframe class="col-sm-12" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3778.0874960654696!2d120.94565261479798!3d15.309307989354302!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x339721b18f4c918b%3A0xdcec3b40f77b4c0e!2sJuliet&#39;s+Restaurant+%2B+Events!5e1!3m2!1sen!2sus!4v1551443126026" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
            </div>
        </div>
    </div>
