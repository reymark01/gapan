    ...
    <div class="row flex-sm-row-reverse">
      <div class="col-sm-8">
        <div class="card" style="margin-top: 20px;">
          <div class="card-header bg-primary text-white text-center">Ponciana Kitchen Restaurant</div>
            <div class="card-body">
              <div class="img"><img src="/tourism/image2/8.jpg" class="img-fluid" style="height: 400px;"></div>
            </div>
        </div>
        <div class="card" style="margin-top: 20px;">
          <div class="card-header bg-primary text-white text-center">Ponciana Kitchen Restaurant</div>
            <div class="card-body">
              <iframe class="col-sm-12" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3778.0267129181425!2d120.94657691479802!3d15.312674989352184!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x339721ae4031a693%3A0xfbe7dc8f83729aef!2sPonciana+Kitchen+Restaurant!5e1!3m2!1sen!2sph!4v1551442740213" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
            </div>
        </div>
    </div>
