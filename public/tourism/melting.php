    ...
    <div class="row flex-sm-row-reverse">
      <div class="col-sm-8">
        <div class="card" style="margin-top: 20px;">
          <div class="card-header bg-primary text-white text-center">Melting Pot Shabu-Shabu, Seafoods and Dimsum</div>
            <div class="card-body">
              <div class="img"><img src="/tourism/image2/25.jpg" class="img-fluid" style="height: 400px;"></div>
            </div>
        </div>
        <div class="card" style="margin-top: 20px;">
          <div class="card-header bg-primary text-white text-center">Melting Pot Shabu-Shabu, Seafoods and Dimsum</div>
            <div class="card-body">
              <iframe class="col-sm-12" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3778.2454098496632!2d120.94569681479778!3d15.300557189359683!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x339721c9fc3cecc1%3A0xa2ed1a7b46bf0890!2sMelting+Pot+Shabu+-+Shabu%2C+Seafoods+and+Dimsum!5e1!3m2!1sen!2sus!4v1551443011525" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
            </div>
        </div>
    </div>
