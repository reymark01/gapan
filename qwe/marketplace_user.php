...
<br>
	<div class="container">
		<div class="row">
			<div class="col-sm-6"><a href="/marketplace/marketplace" type="submit" name="login" class="btn btn-md btn-primary btn-block text-uppercase">Business</a></div>
	
			<div class="col-sm-6"><a href="/marketplace/marketplace_user"stype="submit" name="login" class="btn btn-md btn-primary btn-block text-uppercase active">User</a></div>
		</div>
	</div>
	<br><br>
	...
	<div class="main-section">
		<div class="container">
			<div class="main-section-data">
				<div class="row">
					<div class="col-lg-9 col-md-10 no-pd">
						<div class="main-ws-sec">
							<div class="posts-section">
								<div class="post-bar">
									<div class="post_topbar">
										<div class="usy-dt">
											<img src="/business_profiles/default" class="imgsmall">	
											<div class="usy-name">
												<h3>qwe</h3>
									...
									<div class="job_descp">
										...
										<ul class="template job-dt">
											...
											<li class="template">₱<span class="b-postprice">123</span></li>
										</ul>
										<p class="b-post">qwe</p>
										<div class="row">
