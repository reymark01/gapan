			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<ul class="navbar-nav">
					...
					if (Session::exist('u_sess_id')) {
						...
						?>
						<li class="nav-item dropdown">
							<a href="#" class="nav-link dropdown-toggle" id="accountDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="/user_profiles/<?=Session::get('u_sess_profile')?>"></a>
					...
					if (Session::exist('b_sess_id')) {
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu dropdown-menu-right" aria-labelledby="accountDropdown" style="min-width: 200px">
								<a href="/business_profiles/<?=Session::get('b_sess_profile')?>" class="dropdown-item"><b><?=Session::get('b_sess_b_name')?></b></a><hr>
