							...
							<div class="col-lg-3 col-md-4 pd-left-none no-pd">
								<div class="main-left-sidebar no-margin">
									<div class="user-data full-width">
										<div class="user-profile">
											<div class="username-dt">
												<div class="usr-pic">
													 <img src="/user_photos/<?=$result['profile']?>" alt="user_pic">
												</div>
											</div><!--username-dt end-->
									...
									<div class="tags-sec full-width">
										<ul class="template">
											<li class="template"><a href="#" title="">Help Center</a></li>
											<li class="template"><a href="#" title="">About</a></li>
											<li class="template"><a href="#" title="">Privacy Policy</a></li>
											<li class="template"><a href="#" title="">Community Guidelines</a></li>
											<li class="template"><a href="#" title="">Cookies Policy</a></li>
											<li class="template"><a href="#" title="">Career</a></li>
											<li class="template"><a href="#" title="">Language</a></li>
											<li class="template"><a href="#" title="">Copyright Policy</a></li>
										</ul>
										<div class="cp-sec">
							...
							<div class="col-lg-6 col-md-8 no-pd">
								<div class="main-ws-sec">
									...
									<div class="post-topbar">
										...
										<div class="post-st">
											<ul class="template">
												<li class="template"><a class="post_project" href="#" title="">Post a Project</a></li>
												<li class="template"><a class="post-jb active" href="#" title="">Post a Job</a></li>
											</ul>
										</div><!--post-st end-->
									</div><!--post-topbar end-->
